...
public class OrderServiceImpl implements OrderService {
  ...
  @Override
  @Transactional
  public OrderBO creatOrder(Integer userId, Integer itemId, Integer amount) throws BusinessException {
    ...
    orderBO.setOrderAmount(itemInfomation.getPrice().multiply(new BigDecimal(amount)));
